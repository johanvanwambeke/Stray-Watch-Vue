  ...
  <v-stepper non-linear v-model="stepCount">
   ...
   <v-stepper-items>
    ...
    <v-stepper-content step="2">
     <h1>Location</h1>
     <p>
      Either for finding the animal to help, or to know where to place it back
      after helping, a location is a crusial starting point.
     </p>
     <div
    ...
    <v-stepper-content step="4">
     ...
     <div class="imgAndLoc">
      <div
       ...
       :style="{
        'background-image':
         'url(' + images.filter(x => x.main === true)[0].src + ')'
       }"
      ></div>
