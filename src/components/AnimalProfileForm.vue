<template>
 <div>
  <div v-if="!editable">
   <v-card>
    <v-flex pa-4>
     <h1 class="mb-4">{{ age }} {{ animal }}</h1>
     <v-layout cols wrap class="infoblock">
      <v-flex xs6>
       <p v-if="urgency != ''" class="label">urgency</p>
       <p v-if="urgency != ''">{{ urgency }}</p>
       <p v-if="behavior != ''" class="label">behavior</p>
       <p v-if="behavior != ''">{{ behavior }}</p>
       <p v-if="needs != ''" class="label">needs</p>
       <p v-if="needs != ''">{{ needs }}</p>
       <p v-if="captureStatus && captureStatus != ''" class="label">
        capture status
       </p>
   ...
   >
    ...
    <v-layout cols wrap>
     <v-flex xs6>
      <v-switch
       v-model="sterileDef"
       label="Sterilisation status is known"
      ></v-switch>
     </v-flex>
     <v-flex xs6>
      <v-checkfilled
    ...
    <v-layout cols wrap>
     <v-flex xs6>
      <v-switch
       v-model="vaccinatedDef"
       label="Vaccination status is known"
      ></v-switch>
     </v-flex>
     <v-flex xs6>
      <v-checkfilled
    ...
    <v-layout cols wrap>
     <v-flex xs6>
      <v-switch
       v-model="eartipDef"
       label="Eartip cut status is known"
      ></v-switch>
     </v-flex>
     <v-flex xs6>
      <v-checkfilled
