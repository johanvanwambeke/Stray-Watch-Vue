  ...
  <v-flex xs12 style="position:relative;background-color:gray">
   ...
   <div class="swiper-container">
    ...
    <div class="swiper-wrapper">
     ...
     <div v-if="imagelst.length === 0" class="swiper-slide">
      <div
       class="swiper-slide-image"
       :style="
        `background-image: url(https://cdn2.iconfinder.com/data/icons/picons-basic-2/57/basic2-272_add_new_plus-512.png); `
       "
      ></div>
     </div>
    </div>
...
export default {
 props: { profileID: null, edit: false },
 head: {
  script: [
